...
## [Release 0.16.1] - 2026-02-20 21:31
...
## [Release 0.16.0] - 2026-02-20 20:13
...
## [Release 0.3.12] - 2026-01-02 18:21
...
- **Migration Tests**: Disable completed migration validation test as MessageType to DMsgType migration is successfully completed
...
- **Examples**: Add expected output and type annotations for test compatibility in simple square demo
...
- **Types**: Add missing type annotations for mypy compliance across all modules
...
- **Troubleshooting**: Update logging examples to use HydraLog and DHydraLog constants instead of deprecated logging_config
